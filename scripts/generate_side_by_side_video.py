...
sys.path.append(str(Path("/home/dhruv/Trajectory_Augmentation/third_party/LIBERO").resolve()))
...
def main():
    ...
    bddl_path = "/home/dhruv/Trajectory_Augmentation/third_party/LIBERO/libero/libero/bddl_files/libero_goal/put_the_wine_bottle_on_the_rack.bddl"
