#!/usr/bin/env python3
"""
Batch Inverse Action Validation Across Multiple Demos

Tests inverse action reversibility on demos 1-20 to validate consistency.
Generates per-demo statistics and aggregate validation report.

Usage:
    python test_inverse_action_batch.py [--demo_start 1] [--demo_end 20] [--num_steps 50]
